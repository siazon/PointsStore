...
public class User implements Serializable {
    ...
    public void setpoints(String invite_code) {
        this.points = points;
    }
    ...
    public User(int id, String user_email, String user_name, String user_phone, String user_password, String user_role, int points) {
        this.id = id;
