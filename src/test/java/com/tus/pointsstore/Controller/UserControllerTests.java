...
import com.tus.pointsstore.Controller.UserController;
...
class UserControllerTests {
    ...
    User john = new User(1, "john@gmail.com", "john", "123654", "reredf", "player", 0);
    User pete = new User(2, "pete@gmail.com", "pete", "135654", "reghbr", "admin", 0);
    ...
    void createdUserSuccessfully() throws Exception {
        User terry = new User(2, "terry@gmail.com", "terry", "49838294", "fhrhhd", "admin", 0);
